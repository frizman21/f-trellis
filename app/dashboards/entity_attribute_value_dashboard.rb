...
class EntityAttributeValueDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how entity attribute values are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(entity_attribute_value)
  #   "EntityAttributeValue ##{entity_attribute_value.id}"
  # end
end
