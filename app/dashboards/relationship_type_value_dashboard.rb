...
class RelationshipTypeValueDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how relationship type values are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(relationship_type_value)
  #   "RelationshipTypeValue ##{relationship_type_value.id}"
  # end
end
