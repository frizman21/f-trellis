...
class SkillRevisionDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how skill revisions are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(skill_revision)
  #   "SkillRevision ##{skill_revision.id}"
  # end
end
