...
class DomainDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    fetch_records: Field::HasMany,
    host: Field::String,
    min_crawl_delay_seconds: Field::Number,
    robots_crawl_delay_seconds: Field::Number,
    robots_fetched_at: Field::DateTime,
    robots_status: Field::String,
    robots_txt: Field::Text,
